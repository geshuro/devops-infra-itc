...
#resource aws_waf_web_acl "waf_acl" {
  ...
  #tags = var.tagsvar.tags
}
resource "aws_wafregional_web_acl_association" "waf_alb_association" {
  resource_arn = var.alb_arn //"${aws_alb.foo.arn}"
  web_acl_id   = aws_wafregional_web_acl.waf_acl.id  //"${aws_waf_web_acl.waf_acl.id}"
}