## Modulo de Creación un cluster completo de EKS
## Sigue las indicacciones de Hashicop
##    https://learn.hashicorp.com/terraform/kubernetes/provision-eks-cluster
##    https://github.com/terraform-aws-modules/terraform-aws-eks
##
##  Se habilita la authentifiacion de los pods via IAM-OIDC, para ello en los workers hay que
##  deshabilitar el acceso los metadatos de la instancia via userdata
...
| cluster\_enabled\_log\_types | A list of the desired control plane logging to enable. For more information, see Amazon EKS Control Plane Logging documentation (https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html) | `list(string)` | <pre>[<br>  "api"<br>]</pre> | no |
...
| eks\_oidc\_root\_ca\_thumbprint | Thumbprint of Root CA for EKS OIDC, Valid until 2037 | `list(string)` | <pre>[<br>  "9e99a48a9960b14926bb7f3b02e22da2b0ab7280"<br>]</pre> | no |
